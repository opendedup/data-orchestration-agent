...
- Example: "To explore available datasets, I need to switch to Ask Mode. Would you like me to switch to Ask Mode?"
...
- Use the start_planning agent to Ask thorough, clarifying questions to gather complete requirements
